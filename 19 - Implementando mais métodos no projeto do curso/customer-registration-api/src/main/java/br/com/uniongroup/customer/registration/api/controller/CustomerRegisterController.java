...
@RestController
@RequestMapping(value = "/customer-registers")
public class CustomerRegisterController {
    ...
    @GetMapping("/{id}")
    @ResponseStatus(HttpStatus.OK)
    public CustomerRegisterResponse findOne(@PathVariable Long id) {
        return customerRegisterService.findOne(id);
    }

    @GetMapping
    @ResponseStatus(HttpStatus.OK)
    public List<CustomerRegisterResponse> findAll() {
        return customerRegisterService.findAll();
    }
